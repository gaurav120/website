...
const WebsiteDevelopment = () => {
    ...
    <div style={{backgroundColor:"#000435"}}>
      <div className='main-container' style={{ display: "flex",justifyContent:"space-between" }}>
        ...
        <div className='leftone' style={{ marginleft: "2%", marginTop: "10%" }}>
         <h1 style={{color:"white",fontSize:"60px",marginLeft:"2%"}} >Android Development</h1>
         <br/>
  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src="/images/Android-msg.jpg" className="d-block w-100" alt="..."/>
    </div>
    <div className="carousel-item">
      <img src="/images/Android-twich.jpg" className="d-block w-100" alt="..." />
    </div>
    <div className="carousel-item">
      <img src="/images/Android-last.jpg" className="d-block w-100" alt="..." />
    </div>
  </div>
    ...
    <span className="visually-hidden">Next</span>
      ...
      <div className='main-container' style={{ background: "#000435", display: "flex", justifyContent: "space-between" }}>
        <div className='leftone' style={{ marginLeft:"1%", marginTop: "8%" }}>
          ...
          <h1 style={{ color: "white", fontFamily: "revert-layer", fontSize: "50px" }}> Custom Android Development Services</h1><br></br>
          <h4 style={{color:"white"}}>
          Balaji IT  is a full-service agency comprised of leading web And App development from around the globe.
          </h4>
          <br></br><br></br><br></br>
          <h3 style={{color:"#87CEEB",marginRight:"50%"}}> Java And Ktlin</h3>
          <br></br><br></br><br></br>
          <h3 style={{color:"#87CEEB",marginRight:"51%"}}> Android Studio</h3>
          <br></br><br></br><br></br>
          <h3 style={{color:"#87CEEB",marginRight:"55%"}}> Jetpack Compose</h3>
