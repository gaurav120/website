...
const WebsiteDevelopment = () => {
  ...
  return (
    ...
    <div style={{backgroundColor:"#000435"}}>
      <div className='main-container' style={{ display: "flex",justifyContent:"space-between" }}>
        ...
        <div className='leftone' style={{ marginleft: "%", marginTop: "10%" }}>
         <h1 style={{color:"white",fontSize:"60px",marginLeft:"26%"}} >Graphic Design</h1>
         <br/>
        
          <ul className="space-y-2" style={{color:"white",marginTop:"5%"}}>
          <h5  style={{marginleft:"20%"}}> 
             <FaArrowRight className="text-blue-500">
             </FaArrowRight>Connect With Your Audience<br></br> 
              </h5  > 
             <br></br>
              <h5 style={{marginRight:"15%"}}> 
             <FaArrowRight className="text-blue-500">
             </FaArrowRight>Layout & Composition <br></br> 
              </h5> 
             <br></br>
              <h5 style={{marginRight:"17%"}}> 
             <FaArrowRight className="text-blue-500">
             </FaArrowRight> Visual Communication<br></br> 
              </h5> 
  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src="/images/Graphic-in.jpg" className="d-block w-100" alt="..."/>
    </div>
    <div className="carousel-item">
      <img src="/images/Graphic-here.jpg" className="d-block w-100" alt="..." />
    </div>
    <div className="carousel-item">
      <img src="/images/Graphic-home.jpg" className="d-block w-100" alt="..." />
    </div>
  </div>
    ...
    <span className="visually-hidden">Next</span>
      ...
      <div className='main-container' style={{ background: "#000435", display: "flex", justifyContent: "space-between" }}>
        <div className='leftone' style={{ marginLeft:"1%", marginTop: "8%" }}>
          ...
          <h1 style={{ color: "white", fontFamily: "revert-layer", fontSize: "50px" }}> Custom Graphic Designing  Services</h1><br></br>
          <h4 style={{color:"white"}}>
          Balaji IT  is a full-service agency comprised of leading Graphics from around the globe.
          </h4>
          <br></br><br></br><br></br>
          <h3 style={{color:"#87CEEB",marginRight:"50%"}}> Adobe Illustrator</h3>
          <br></br><br></br><br></br>
          <h3 style={{color:"#87CEEB",marginRight:"51%"}}>Canva </h3>
          <br></br><br></br><br></br>
          <h3 style={{color:"#87CEEB",marginRight:"52%"}}> Figma</h3>
